...
window.gtKeluar = function() {
  Swal.fire({
    ...
    html: '<p style="color:#64748b;margin:0;">Sesi Anda akan diakhiri.<br>Data yang belum tersimpan akan di-flush terlebih dahulu.</p>',
    icon: 'question',
    iconColor: '#dc2626',
    ...
    // Flush pending data lalu reload
    var doReload = function() { location.reload(); };
    if (typeof window.GT_FLUSH_NOW === 'function') {
      Swal.fire({
        title: 'Menyimpan data...',
        html: '<p style="color:#64748b;margin:0;">Harap tunggu sebentar.</p>',
        icon: 'info',
        iconColor: '#6366f1',
...
// Alias untuk backward compat jika ada yang masih panggil logout()
