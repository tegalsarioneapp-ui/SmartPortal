...
/* ══ FUNGSI KELUAR TERPADU — SmartPortal RT ══ */
window.gtKeluar = function() {
  Swal.fire({
    ...
    try { window.loggedInWarga = null; } catch(_) {}
    try { document.body.classList.remove('warga-portal-aktif'); } catch(_) {}
        ...
        setTimeout(function(){
            ...
            if (!window.__GT_PORTAL_ACTIVE__) {
                ...
                if (loginForm) {
                    ...
                    // Smooth entrance
                    setTimeout(function(){
                        loginForm.style.transition = 'opacity 0.4s ease, transform 0.4s ease';
                ...
                // Juga dismiss splash-view lama jika masih ada
                if (typeof window.bukaFormLogin === 'function') {
                    // sudah handled di atas, tidak perlu panggil lagi
                }
            }
        }, 580);
  }
    ...
    window.prosesLoginUniversal = function(e) {
        ...
        if (targetPortal !== null) {
            ...
            Swal.fire({
                ...
                window.window.__GT_LOGGED_ID__   = univId;
    window.__GT_LOGGED_NAMA__ = namaWarga || univId;
