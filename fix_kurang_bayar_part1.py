...
# ─────────────────────────────────────────────
# PATCH 1: Tambah stat box "Kurang Bayar"
# ─────────────────────────────────────────────
old1 = '                <div class="stat-box" style="border-color:var(--danger);"><i class="fa-solid fa-circle-xmark bg-icon" style="color:var(--danger) !important;"></i><h4>Belum Bayar</h4><h2 id="iuran-stat-belum">0</h2></div>\n            </div>'
new1 = '                <div class="stat-box" style="border-color:var(--danger);"><i class="fa-solid fa-circle-xmark bg-icon" style="color:var(--danger) !important;"></i><h4>Belum Bayar</h4><h2 id="iuran-stat-belum">0</h2></div>\n                <div class="stat-box" style="border-color:#f59e0b;"><i class="fa-solid fa-triangle-exclamation bg-icon" style="color:#f59e0b !important;"></i><h4>Ada Kurang Bayar</h4><h2 id="iuran-stat-kurang" style="color:#f59e0b;">0</h2></div>\n            </div>'

if old1 in html:
    html = html.replace(old1, new1, 1)
    print("OK: PATCH 1 - stat kurang bayar")
else:
    print("GAGAL: PATCH 1")

# ─────────────────────────────────────────────
# PATCH 2: Fix duplikat <table> tag + tambah card kurang bayar
# ─────────────────────────────────────────────
...
with open(FILE, "w", encoding="utf-8") as f:
    f.write(html)
print("PART 1 SELESAI - file disimpan")