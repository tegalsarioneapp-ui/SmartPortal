...
<p class="pembuka">Menyatakan dengan sesungguhnya bahwa PIHAK PERTAMA telah menyusun dan menyerahkan Laporan Keuangan (Buku Kas) RT 005 Periode Bulan \${blnStr} kepada PIHAK KEDUA, dengan rincian data keuangan sebagai berikut:</p>
<!-- BAGIAN A: KAS UTAMA -->
<div class="section-title">Bagian A &mdash; Laporan Kas Utama</div>
<table class="trx">
  <thead><tr>
  ...
  <tfoot><tr>
    ...
    <td colspan="2" style="text-align:right;">\${fmt(sAkh)}</td>
  </tr></tfoot>
</table>
<table class="sum-table">
  <tbody>
    <tr><td class="lbl">Saldo Awal</td><td class="val">\${fmt(sAwal)}</td></tr>
    <tr><td class="lbl">Total Pemasukan</td><td class="val masuk">\${fmt(totMU)}</td></tr>
    <tr><td class="lbl">Total Pengeluaran</td><td class="val keluar">\${fmt(totKU)}</td></tr>
  </tbody>
  <tfoot><tr><td class="lbl">Saldo Akhir</td><td class="val">\${fmt(sAkh)}</td></tr></tfoot>
</table>

<!-- BAGIAN B: DANA KHUSUS -->
<div class="section-title">Bagian B &mdash; Laporan Dana Khusus</div>
<table class="trx">
  <thead><tr>
    <th style="width:35px;text-align:center;">No</th>
    <th style="width:90px;">Tanggal</th>
  ...
  <tfoot><tr>
    <td colspan="3" style="text-align:right;">Total Dana Khusus</td>
    <td style="text-align:center;font-weight:700;">—</td>
    <td style="text-align:right;">\${fmt(totMK - totKK)}</td>
  </tr></tfoot>
</table>
<table class="sum-table">
  <tbody>
    <tr><td class="lbl">Total Pemasukan Khusus</td><td class="val masuk">\${fmt(totMK)}</td></tr>
    <tr><td class="lbl">Total Pengeluaran Khusus</td><td class="val keluar">\${fmt(totKK)}</td></tr>
  </tbody>
  <tfoot><tr><td class="lbl">Saldo Dana Khusus</td><td class="val">\${fmt(totMK - totKK)}</td></tr></tfoot>
</table>
<!-- REKAPITULASI -->
<div class="section-title">Rekapitulasi Keseluruhan</div>
<table class="rekap-table">
  <tbody>
    <tr><td class="lbl">Kas Utama &mdash; Pemasukan</td><td class="val masuk">\${fmt(totMU)}</td></tr>
    <tr><td class="lbl">Kas Utama &mdash; Pengeluaran</td><td class="val keluar">\${fmt(totKU)}</td></tr>
    <tr><td class="lbl">Dana Khusus &mdash; Pemasukan</td><td class="val masuk">\${fmt(totMK)}</td></tr>
    <tr><td class="lbl">Dana Khusus &mdash; Pengeluaran</td><td class="val keluar">\${fmt(totKK)}</td></tr>
    <tr><td class="lbl">Saldo Awal</td><td class="val">\${fmt(sAwal)}</td></tr>
  </tbody>
  <tfoot>
    <tr><td class="lbl">Total Saldo Akhir Keseluruhan</td><td class="val">\${fmt(sAkh + (totMK - totKK))}</td></tr>
  </tfoot>
</table>

<!-- TEKS PENUTUP -->
<p class="penutup">Demikian Berita Acara Laporan Kas ini dibuat dengan sebenar-benarnya untuk dapat dipergunakan sebagaimana mestinya. Apabila di kemudian hari terdapat kekeliruan dalam laporan ini, akan dilakukan perbaikan sebagaimana mestinya.</p>
...
<table class="rekap-table">
  <tbody>
    ...
    <tr><td class="lbl">Total Pemasukan Kas Utama</td><td class="val">\${fmtRp(totMU)}</td></tr>
    <tr><td class="lbl">Total Pengeluaran Kas Utama</td><td class="val">\${fmtRp(totKU)}</td></tr>
    <tr><td class="lbl">Total Pemasukan Dana Khusus</td><td class="val">\${fmtRp(totMK)}</td></tr>
    <tr><td class="lbl">Total Pengeluaran Dana Khusus</td><td class="val">\${fmtRp(totKK)}</td></tr>
  </tbody>
  <tfoot>
    <tr><td class="lbl">Saldo Akhir Kas Utama</td><td class="val">\${fmtRp(sAkh)}</td></tr>
  </tfoot>
</table>
...
html = html.substring(0, idxHtmlStart) + newBlock + html.substring(idxHtmlEnd);
writeFileSync(FILE, html, "utf8");
console.log("✅ PATCH SELESAI - htmlOut berhasil diperbarui!");